      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-slate-700">DataQuality Pipeline</span>
          </div>

          <nav className="flex items-center gap-5">
            <Link to="/" className="text-xs text-slate-500 hover:text-slate-800 transition-colors">Home</Link>
            <Link to="/upload" className="text-xs text-slate-500 hover:text-slate-800 transition-colors">Upload</Link>
          </nav>
